...
<div class="row">
    <div class="container-white">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php foreach ($all_data_Kemiskinan as $data) : ?>
                    <tr>
                        <td><?= $data->ID; ?></td>
    ...
    <div class="container-white">
        <h3>Indeks Yang Mempengaruhi Kemiskinan</h3>
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th scope="col">ID</th>
            ...
            <tbody>
                <?php foreach ($all_data_IndeksYangMempengaruhi as $data) : ?>
                    <tr>
                        <td><?= $data->ID; ?></td>
                        <td><?= $data->{'Keterangan'}; ?></td>
                        <td><?= $data->{'2022'}; ?></td>
...
<div class="row">
    <div class="container-white">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php foreach ($all_data_Inflasi as $data) : ?>
                    <tr>
                        <td><?= $data->ID; ?></td>
                        <td><?= $data->{'keterangan'}; ?></td>
                        <td><?= $data->{'2022'}; ?></td>
    ...
    <div class="container-white">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php foreach ($all_data_Ketenagakerjaan as $data) : ?>
                    <tr>
                        <td><?= $data->ID; ?></td>
                        <td><?= $data->{'Keterangan'}; ?></td>
                        <td><?= $data->{'2022'}; ?></td>
