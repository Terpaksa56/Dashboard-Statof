...
<div class="row">
    <div class="container-white">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php foreach ($all_data_AngkaHarapanHidup as $data) : ?>
                    <tr>
                        <td><?= $data->ID; ?></td>
    ...
    <div class="container-white">
        <h3>Indeks Pembangunan Manusia</h3>
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th scope="col">ID</th>
            ...
            <tbody>
                <?php foreach ($all_data_IndeksPembangunan as $data) : ?>
                    <tr>
                        <td><?= $data->ID; ?></td>
...
<div class="row">
    <div class="container-white">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php foreach ($all_data_LamaSekolah as $data) : ?>
                    <tr>
                        <td><?= $data->ID; ?></td>
                        <td><?= $data->{'Kategori'}; ?></td>
                        <td><?= $data->{'2022'}; ?></td>
    ...
    <div class="container-white">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php foreach ($all_data_PengeluaranPerkapita as $data) : ?>
                    <tr>
                        <td><?= $data->ID; ?></td>
                        <td><?= $data->{'Kategori'}; ?></td>
                        <td><?= $data->{'2022'}; ?></td>
